...
import uk.nhs.hee.tis.trainee.credentials.mapper.CredentialLogMapper;
...
public class LogIssuedOutcome {
  ...
  ResponseEntity<String> logIssuedResource(
    ...
    URI redirectUri = issuedResourceService.logIssuedResource(credentialLogDto, code, state,
